...
> 版本：Minecraft Java 1.20.1 · Forge 47.4.22 · 模组 **qlmzombie-3.0.0.beta.build44**
> 同步日期：2026-08-17
...
| 项 | 状态 |
|:---|:-----|
| 模组 JAR | `qlmzombie-3.0.0.beta.build44.jar` ✅ |
...
| Yes Steve Model | 服务端已启用（`side=BOTH` 模型同步，修复物品错位）✅ |
