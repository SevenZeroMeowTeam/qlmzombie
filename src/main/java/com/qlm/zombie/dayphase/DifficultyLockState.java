...
public class DifficultyLockState extends SavedData {
    ...
    public static DifficultyLockState get(MinecraftServer server) {
        return server.getLevel(net.minecraft.world.level.Level.OVERWORLD).getDataStorage().computeIfAbsent(DifficultyLockState::load, DifficultyLockState::new, DATA_NAME);
    }
