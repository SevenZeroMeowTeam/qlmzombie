...
public enum HordeWave {
    WAVE_1(20, 0.0, 0, 0, 0),
    WAVE_2(35, 0.15, 0, 0, 0),
    WAVE_3(50, 0.30, 0.20, 15, 0),
    WAVE_4(70, 0.45, 0.15, 20, 0),
    WAVE_5(100, 0.60, 0.25, 30, 1);
    ...
    HordeWave(int zombieCount, double eliteChance, double skeletonChance, int skeletonCount, int bossCount) {
