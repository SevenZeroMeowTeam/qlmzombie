...
public class ModDamageSource
{
    ...
    public static final ResourceKey<DamageType> DIE_OF_THIRST_KEY = ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(QLMZombieMod.MOD_ID, "dehydrate".toLowerCase(Locale.ROOT)));
