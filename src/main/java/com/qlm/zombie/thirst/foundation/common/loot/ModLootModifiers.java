package com.qlm.zombie.thirst.foundation.common.loot;
...
public class ModLootModifiers {
    ...
    static {
        LOOT_MODIFIERS = DeferredRegister.create(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, QLMZombieMod.MOD_ID);
